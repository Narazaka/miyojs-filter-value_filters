...
MiyoFilters.set_value_filters = (argument, request, id) ->
	@value_filters = argument.set_value_filters
	argument
MiyoFilters.append_value_filters = (argument, request, id) ->
	for name in argument.append_value_filters
		@value_filters.push name
	argument
MiyoFilters.prepend_value_filters = (argument, request, id) ->
	for name in argument.prepend_value_filters
		@value_filters.unshift name
	argument
MiyoFilters.remove_value_filters = (argument, request, id) ->
