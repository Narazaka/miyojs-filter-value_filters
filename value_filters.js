...
MiyoFilters.set_value_filters = function(argument, request, id) {
  this.value_filters = argument.set_value_filters;
  return argument;
};

MiyoFilters.append_value_filters = function(argument, request, id) {
...
MiyoFilters.prepend_value_filters = function(argument, request, id) {
  var name, _i, _len, _ref;
...
MiyoFilters.remove_value_filters = function(argument, request, id) {
...
//# sourceMappingURL=value_filters.map
